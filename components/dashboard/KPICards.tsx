import {
  PieChart, Radio, Clock4, Send, Clock, Inbox, Zap, Archive, FolderX,
} from "lucide-react";
import { kpiData } from "@/lib/data";

const icons = [PieChart, Radio, Clock4, Send, Clock, Inbox, Zap, Archive, FolderX];
...
const colorConfig = [
  ...
  { border: "border-t-indigo-500", iconBg: "bg-indigo-500/15 dark:bg-indigo-500/15 bg-indigo-100",  iconTxt: "text-indigo-600 dark:text-indigo-400",  delta: "text-emerald-600 dark:text-emerald-400"},
  { border: "border-t-orange-500", iconBg: "bg-orange-500/15 dark:bg-orange-500/15 bg-orange-100",  iconTxt: "text-orange-600 dark:text-orange-400",  delta: "text-orange-600 dark:text-orange-400" },
...
export function KPICards() {
  return (
    <div className="grid grid-cols-3 sm:grid-cols-3 xl:grid-cols-9 gap-3">
      {kpiData.map((kpi, i) => {
        const Icon = icons[i];
