const counters = [
  { label: "Action Taken",    value: 11, light: "bg-emerald-50 border-emerald-200 text-emerald-700", dark: "dark:bg-emerald-500/8 dark:border-emerald-500/20 dark:text-emerald-400" },
  { label: "Policy Improved", value: 4,  light: "bg-blue-50 border-blue-200 text-blue-700",         dark: "dark:bg-blue-500/8 dark:border-blue-500/20 dark:text-blue-400"         },
  { label: "Query Replied",   value: 8,  light: "bg-cyan-50 border-cyan-200 text-cyan-700",         dark: "dark:bg-cyan-500/8 dark:border-cyan-500/20 dark:text-cyan-400"         },
  { label: "No Action Req.",  value: 6,  light: "bg-slate-100 border-slate-200 text-slate-600",      dark: "dark:bg-slate-500/8 dark:border-slate-500/20 dark:text-slate-400"      },
  { label: "Pending Review",  value: 5,  light: "bg-amber-50 border-amber-200 text-amber-700",      dark: "dark:bg-amber-500/8 dark:border-amber-500/20 dark:text-amber-400"      },
  { label: "Total Items",     value: 34, light: "bg-purple-50 border-purple-200 text-purple-700",   dark: "dark:bg-purple-500/8 dark:border-purple-500/20 dark:text-purple-400"   },
];
  ...
  return (
    <div className="glass rounded-xl overflow-hidden h-full">
      ...
      <div className="p-4 grid grid-cols-3 gap-2.5">
        {counters.map((c) => (
          <div key={c.label} className={`p-3 rounded-xl border text-center ${c.light} ${c.dark}`}>
